...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    ...
    // biome-ignore lint/a11y/useSemanticElements: div is appropriate for OTP separator with icon
    // biome-ignore lint/a11y/useAriaPropsForRole: separator is decorative, aria-valuenow not applicable
